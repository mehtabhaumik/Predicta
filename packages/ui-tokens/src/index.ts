...
export const primitiveClasses = {
  ...
  badge: 'predicta-badge',
  button: 'predicta-button',
  card: 'predicta-card',
  drawer: 'predicta-drawer',
  ...
  mediaLogo: 'predicta-media-logo',
  mediaWatermark: 'predicta-media-watermark',
  modal: 'predicta-modal',
  pageShell: 'predicta-page-shell',
  panel: 'predicta-panel',
  pill: 'predicta-pill',
  sectionStack: 'predicta-section-stack',
  select: 'predicta-select',
  stateBanner: 'predicta-state-banner',
  stickyAction: 'predicta-sticky-action',
