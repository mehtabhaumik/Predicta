...
> = {
  ...
  NADI: {
    action: 'Move the user into the Jaimini room and give one calm next focus around soul role, visible identity, or current life chapter.',
    evidence: 'Use this only as a legacy alias. Active evidence must come from Jaimini indicators such as Atmakaraka, Karakamsha, Arudha, Upapada, aspects, and Chara Dasha.',
    forbidden: 'Do not present Nadi as an active room, claim palm-leaf access, or mix KP cusp judgement into this alias.',
    label: 'Jaimini Predicta',
    prediction: 'Start with Jaimini soul role, visible identity, destiny pattern, and active life chapter.',
    safety: 'Name that old Nadi entry points now open Jaimini; keep agency and avoid manuscript certainty.',
    school: 'NADI',
    startsWith: 'legacy alias handoff into Jaimini soul-role guidance',
  },
  NUMEROLOGY: {
