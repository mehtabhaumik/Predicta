...
const CHART_ROLES: Partial<Record<ChartType, string>> = {
  D1: 'main life chart',
  D2: 'wealth and nourishment lens',
  D3: 'courage and sibling lens',
  D4: 'property and inner stability lens',
...
const VARGA_READING_NOTES: Partial<Record<ChartType, string>> = {
  D2: 'Do not read D2 like ordinary 1st-to-12th houses. Hora is mainly a wealth, sustenance, and resource-handling division judged through Sun/Moon hora and planet strength.',
  D3: 'D3 is a focused Drekkana lens for courage, siblings, effort, and stamina. Read it with D1 3rd-house context.',
  D4: 'D4 refines property, residence, assets, and inner stability. Read it with D1 4th-house context.',
  ...
  D7: 'D7 refines children, fertility themes, creativity, and legacy. Read it with D1 5th-house context.',
  D8: 'D8 is a narrow hidden-pressure and transformation lens. It needs careful, non-fearful reading.',
  D9: 'D9 is Navamsha: dharma, marriage maturity, fortune, and deeper planet strength. Read it with D1, never alone.',
  ...
  D16: 'D16 refines vehicles, comforts, luxury, and enjoyment. It is not a full life chart.',
  ...
  D30: 'D30 refines stress, misfortune signatures, and protection needs. Keep the language careful and non-fatalistic.',
  ...
  D60: 'D60 is a deep karmic texture chart and needs a very accurate birth time. Treat it as premium-level confirmation, not casual prediction.',
};
