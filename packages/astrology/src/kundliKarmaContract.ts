  ...
  fixture('fixture-needs-data-preta-shrap', 'Needs-data Shrap fixture', 'needs_data', {
    ...
    items: [
      item({
        ...
        status: 'needs_data',
        strength: 'none',
        summary: 'This Shrap indicator is known but stays pending until safe approved evidence exists.',
        whyPresent: 'The rule is intentionally pending; Predicta must not fake a reading.',
      }),
    ],
    missingData: ['approved Preta Shrap evidence'],
  ...
  fixture('fixture-no-ai-local-memory', 'No-AI local memory fixture', 'no_ai_local_memory', {
    items: [
      item({
        ...
        ruleId: 'rule-dosh-manglik-kuja',
        status: 'not_present',
        summary: 'Predicta can answer a snapshot question from the Kundli Karma packet.',
        whyPresent: 'No AI is required when the Kundli Karma packet is already available.',
      }),
    ],
    noAiRequiredFor: [
      'show top Kundli Karma signals',
      'explain Dosh/Shrap/Yog/Lal Kitab status from the Kundli Karma packet',
      'show missing data honestly',
    ],
    summary: 'This fixture proves Predicta can answer from local Kundli Karma memory without spending AI.',
