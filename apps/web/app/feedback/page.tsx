...
const feedbackCopy: Record<SupportedLanguage, FeedbackCopy> = {
  ...
  hi: {
    ...
    areaOptions: [
      ...
      { label: 'KP या नाड़ी', value: 'schools' },
    ...
    cards: [
      ...
      {
        body: 'स्क्रीनशॉट, Predicta से पूछा गया सटीक सवाल, और आप अंग्रेजी, हिन्दी या गुजराती में थे.',
  ...
  gu: {
    ...
    areaOptions: [
      ...
      { label: 'KP અથવા નાડી', value: 'schools' },
    ...
    cards: [
      ...
      {
        body: 'સ્ક્રીનશોટ, Predicta ને પૂછેલો ચોક્કસ પ્રશ્ન, અને તમે અંગ્રેજી, હિન્દી કે ગુજરાતી માં હતા.',
