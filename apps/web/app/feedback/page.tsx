...
const feedbackCopy: Record<SupportedLanguage, FeedbackCopy> = {
  ...
  hi: {
    ...
    areaOptions: [
      ...
      { label: 'प्रेडिक्टा का जवाब', value: 'chat' },
      { label: 'कुंडली या चार्ट', value: 'charts' },
      { label: 'रिपोर्ट या पीडीएफ', value: 'report' },
      { label: 'कृष्णमूर्ति पद्धति या नाड़ी', value: 'schools' },
      { label: 'भाषा या अनुवाद', value: 'language' },
      { label: 'सुरक्षा चिंता', value: 'safety' },
    ],
    body: 'जो भी प्रेडिक्टा को उपयोग करना मुश्किल बनाता है, बताएं: टूटा बटन, अस्पष्ट रिपोर्ट, गलत भाषा, कटा हुआ पाठ, भ्रमित करने वाला संकेत या सुरक्षा चिंता.',
    cards: [
      {
      ...
      {
        body: 'स्क्रीनशॉट, प्रेडिक्टा से पूछा गया सटीक सवाल, और आप अंग्रेजी, हिन्दी या गुजराती में थे.',
        title: 'सबसे उपयोगी क्या है',
      },
      {
        body: 'टूटे रास्ते, भ्रमित भाषा, असुरक्षित जवाब, चार्ट/रिपोर्ट समस्याएं, और जहां 10 साल का बच्चा खो जाए.',
        title: 'हम क्या समीक्षा करते हैं',
      },
    ],
    dashboard: 'डैशबोर्ड खोलें',
    emailBackup: 'ईमेल से भेजें',
    emailBodyLabels: {
      area: 'क्षेत्र',
      email: 'ईमेल',
      message: 'संदेश',
    ...
    emailSubject: 'प्रेडिक्टा सुझाव',
    footerBody:
      'डैशबोर्ड पर जाएं, कुंडली बनाएं, प्रेडिक्टा से असली सवाल पूछें, और जहां बात स्पष्ट न लगे वहां सुझाव भेजें.',
    footerTitle: 'और देखना चाहते हैं?',
    formEyebrow: 'PREDICTA सुझाव',
    formTitle: 'साफ बताएं क्या हुआ.',
    messageLabel: 'क्या हुआ?',
    messagePlaceholder:
      'उदाहरण: मैंने चार्ट से D9 दबाया, चैट खुली, पर प्रेडिक्टा को चुना हुआ चार्ट याद नहीं रहा.',
    messageRequired: 'भेजने से पहले एक साफ नोट लिखें.',
    notShared: 'साझा नहीं किया',
    notSure: 'पक्का नहीं',
    pageLabel: 'पेज या स्क्रीन',
    pagePlaceholder: 'उदाहरण: डैशबोर्ड, चैट, रिपोर्ट, कृष्णमूर्ति पद्धति',
    pass: 'पास उपयोग करें',
    saved:
      'सेव हो गया. धन्यवाद. अगले सुझाव समीक्षा से पहले हम इसे देखेंगे, और नोट इस डिवाइस पर भी रखा गया है.',
    savedLocally:
      'इस डिवाइस पर सेव हो गया. स्क्रीनशॉट भेजने हों तो ईमेल बटन भी उपयोग करें.',
    send: 'सुझाव भेजें',
    sending: 'भेज रहे हैं...',
    signedInEmailNote:
      'आप साइन इन हैं, इसलिए आगे संपर्क के लिए प्रेडिक्टा यही ईमेल उपयोग करेगी. अलग ईमेल डालने की जरूरत नहीं है.',
    testerLabel: 'सुझाव कौन साझा कर रहा है?',
    testerOptions: [
      { label: 'दोस्त या परिवार', value: 'friends-family' },
      { label: 'संस्थापक समीक्षा', value: 'founder-review' },
      { label: 'निवेशक या समीक्षक', value: 'investor-demo' },
      { label: 'सार्वजनिक आगंतुक', value: 'public' },
    ],
    title: 'जहां उलझन लगी, हमें बताएं.',
  ...
  gu: {
    ...
    areaOptions: [
      ...
      { label: 'પ્રેડિક્ટા નો જવાબ', value: 'chat' },
      { label: 'કુંડળી અથવા ચાર્ટ્સ', value: 'charts' },
      { label: 'રિપોર્ટ અથવા પીડીએફ', value: 'report' },
      { label: 'કૃષ્ણમૂર્તિ પદ્ધતિ અથવા નાડી', value: 'schools' },
      { label: 'ભાષા અથવા અનુવાદ', value: 'language' },
      { label: 'સુરક્ષા ચિંતા', value: 'safety' },
    ],
    body: 'પ્રેડિક્ટા ઉપયોગ કરવું મુશ્કેલ બને તેવી કોઈ પણ વાત જણાવો: તૂટેલું બટન, અસ્પષ્ટ રિપોર્ટ, ખોટી ભાષા, કપાયેલ લખાણ, ગૂંચવતો સંકેત અથવા સુરક્ષા ચિંતા.',
    cards: [
      {
      ...
      {
        body: 'સ્ક્રીનશોટ, પ્રેડિક્ટા ને પૂછેલો ચોક્કસ પ્રશ્ન, અને તમે અંગ્રેજી, હિન્દી કે ગુજરાતી માં હતા.',
        title: 'સૌથી ઉપયોગી શું છે',
      },
      {
        body: 'તૂટેલા રસ્તા, ગૂંચવતી ભાષા, અસુરક્ષિત જવાબ, ચાર્ટ/રિપોર્ટ સમસ્યાઓ, અને જ્યાં 10 વર્ષનું બાળક ખોવાઈ જાય.',
        title: 'અમે શું સમીક્ષા કરીએ છીએ',
      },
    ],
    dashboard: 'ડેશબોર્ડ ખોલો',
    emailBackup: 'ઈમેલથી મોકલો',
    emailBodyLabels: {
      area: 'વિભાગ',
      email: 'ઈમેલ',
      message: 'સંદેશ',
    ...
    emailLabel: 'તમારું ઈમેલ',
    emailPlaceholder: 'વૈકલ્પિક, જવાબ જોઈએ તો ઉપયોગી રહેશે',
    emailSubject: 'પ્રેડિક્ટા સૂચન',
    footerBody:
      'ડેશબોર્ડ પર જાઓ, કુંડળી બનાવો, પ્રેડિક્ટા ને સાચો પ્રશ્ન પૂછો, અને જ્યાં વાત સ્પષ્ટ ન લાગે ત્યાં સૂચન મોકલો.',
    footerTitle: 'હજુ જોવું છે?',
    formEyebrow: 'PREDICTA સૂચન',
    formTitle: 'સાફ કહો શું થયું.',
    messageLabel: 'શું થયું?',
    messagePlaceholder:
      'ઉદાહરણ: મેં ચાર્ટમાંથી D9 દબાવ્યું, ચેટ ખુલી, પણ પ્રેડિક્ટા ને પસંદ કરેલો ચાર્ટ યાદ ન રહ્યો.',
    messageRequired: 'મોકલતા પહેલાં એક સ્પષ્ટ નોંધ લખો.',
    notShared: 'સાંઝું કર્યું નથી',
    notSure: 'ખાતરી નથી',
    pageLabel: 'પેજ અથવા સ્ક્રીન',
    pagePlaceholder: 'ઉદાહરણ: ડેશબોર્ડ, ચેટ, રિપોર્ટ, કૃષ્ણમૂર્તિ પદ્ધતિ',
    pass: 'પાસ ઉપયોગ કરો',
    saved:
      'સેવ થઈ ગયું. આભાર. આગામી સૂચન સમીક્ષા પહેલાં અમે આ જોશું, અને નોંધ આ ડિવાઇસ પર પણ રાખી છે.',
    savedLocally:
      'આ ડિવાઇસ પર સેવ થયું. સ્ક્રીનશોટ મોકલવા હોય તો ઈમેલ બટન પણ ઉપયોગ કરો.',
    send: 'સૂચન મોકલો',
    sending: 'મોકલી રહ્યા છીએ...',
    signedInEmailNote:
      'તમે સાઇન ઇન છો, એટલે આગળ સંપર્ક માટે પ્રેડિક્ટા આ ઈમેલ ઉપયોગ કરશે. અલગ ઈમેલ નાખવાની જરૂર નથી.',
    testerLabel: 'સૂચન કોણ શેર કરે છે?',
    testerOptions: [
      { label: 'મિત્ર અથવા પરિવાર', value: 'friends-family' },
      { label: 'સ્થાપક સમીક્ષા', value: 'founder-review' },
