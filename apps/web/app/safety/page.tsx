...
> = {
  ...
  hi: {
    checks: [
      ...
      'वैदिक, कृष्णमूर्ति पद्धति और नाड़ी प्रेडिक्टा की साफ अलग पहचान',
      'चिंताजनक जवाब रिपोर्ट करने का आसान तरीका',
      'असुरक्षित बदलाव लोगों तक पहुंचने से पहले रोकना',
    ],
    checksSection: {
      body: 'प्रेडिक्टा संकट की भाषा, गंभीर फैसलों, मिली-जुली भाषा, ज्योतिष पद्धति की उलझन और शांत जवाबों के लिए तैयार रहती है.',
      eyebrow: 'हम किसके लिए तैयार हैं',
      title: 'प्रेडिक्टा वास्तविक जीवन के जोखिम भरे सवालों के लिए तैयार है.',
    },
    commitments: [
      {
        body: 'प्रेडिक्टा गंभीर ज्योतिष सवालों का जवाब चिंतन और मार्गदर्शन की तरह देती है, योग्य मदद या वास्तविक निर्णय की जगह नहीं.',
      ...
      {
        body: 'प्रेडिक्टा हानिकारक निर्देश, गैरकानूनी काम, बच्चों से जुड़ी यौन सामग्री, हिंसक मार्गदर्शन और असुरक्षित अनुरोध रोकती है.',
      ...
      {
        body: 'प्रेडिक्टा अधूरी भाषा, मिली-जुली भाषा और कठिन वास्तविक जीवन के सवालों के लिए तैयार है.',
        title: 'कठिन सवालों के लिए तैयार',
      },
      {
        body: 'वैदिक प्रेडिक्टा, कृष्णमूर्ति पद्धति प्रेडिक्टा और नाड़ी प्रेडिक्टा अलग रखे जाते हैं ताकि हर पद्धति अपनी परंपरा से बोले.',
        title: 'ज्योतिष पद्धतियां अलग रहती हैं',
      },
      {
        body: 'नाड़ी प्रेडिक्टा यह दावा नहीं करेगी कि उसे कोई वास्तविक प्राचीन पांडुलिपि मिली या उसका प्रवेश मिला.',
    ...
    final:
      'गंभीर फैसलों में योग्य सहायता के साथ प्रेडिक्टा को आध्यात्मिक समय-दृष्टि की तरह उपयोग करें.',
    founderPromise:
      'अनिश्चित क्षणों में प्रेडिक्टा उपयोगी, सुंदर और सम्मानजनक रहनी चाहिए. सुरक्षा पर कोई समझौता नहीं.',
    hero: {
      body: 'शांत मार्गदर्शन, चार्ट प्रमाण और साफ सीमाओं के साथ गंभीर ज्योतिष सवाल पूछें.',
      eyebrow: 'सार्वजनिक सुरक्षा वादा',
      title: 'प्रेडिक्टा guide करने के लिए बनी है, डराने के लिए नहीं.',
    },
    ...
    standard: {
      body: 'प्रेडिक्टा डर, पक्की गारंटी या संकट में अति-दखल के बिना मार्गदर्शन देती है. लक्ष्य देखभाल है, अनावश्यक इनकार नहीं.',
      eyebrow: 'हमारा मानक',
  ...
  gu: {
    checks: [
      ...
      'વૈદિક, કૃષ્ણમૂર્તિ પદ્ધતિ અને નાડી પ્રેડિક્ટા વચ્ચે સ્પષ્ટ અલગતા',
      'ચિંતાજનક જવાબ રિપોર્ટ કરવાની સરળ રીત',
      'અસુરક્ષિત ફેરફારો લોકો સુધી પહોંચે તે પહેલાં રોકવા',
    ],
    checksSection: {
      body: 'પ્રેડિક્ટા સંકટની ભાષા, ગંભીર નિર્ણયો, મિશ્ર ભાષા, જ્યોતિષ પદ્ધતિની ગૂંચવણ અને શાંત જવાબો માટે તૈયાર રહે છે.',
      eyebrow: 'અમે કઈ બાબતો માટે તૈયાર છીએ',
      title: 'પ્રેડિક્ટા વાસ્તવિક જીવનના જોખમી પ્રશ્નો માટે તૈયાર છે.',
    },
    commitments: [
      {
        body: 'પ્રેડિક્ટા ગંભીર જ્યોતિષ પ્રશ્નોના જવાબ વિચાર અને માર્ગદર્શન તરીકે આપે છે, યોગ્ય મદદ અથવા વાસ્તવિક નિર્ણયના વિકલ્પ તરીકે નહીં.',
      ...
      {
        body: 'પ્રેડિક્ટા હાનિકારક સૂચનાઓ, ગેરકાયદેસર કામ, બાળકો સંબંધિત યૌન સામગ્રી, હિંસક માર્ગદર્શન અને અસુરક્ષિત વિનંતીઓ રોકે છે.',
      ...
      {
        body: 'પ્રેડિક્ટા અધૂરી ભાષા, મિશ્ર ભાષા અને મુશ્કેલ વાસ્તવિક જીવનના પ્રશ્નો માટે તૈયાર છે.',
        title: 'મુશ્કેલ પ્રશ્નો માટે તૈયાર',
      },
      {
        body: 'વૈદિક પ્રેડિક્ટા, કૃષ્ણમૂર્તિ પદ્ધતિ પ્રેડિક્ટા અને નાડી પ્રેડિક્ટા અલગ રહે છે જેથી દરેક પદ્ધતિ પોતાની પરંપરા પ્રમાણે બોલે.',
        title: 'જ્યોતિષ પદ્ધતિઓ અલગ રહે છે',
      },
      {
        body: 'નાડી પ્રેડિક્ટા એવો દાવો નહીં કરે કે તેને કોઈ વાસ્તવિક પ્રાચીન પાંડુલિપિ મળી અથવા તેનો પ્રવેશ મળ્યો.',
    ...
    final:
      'ગંભીર નિર્ણયોમાં યોગ્ય સહાય સાથે પ્રેડિક્ટા ને આધ્યાત્મિક સમય-દૃષ્ટિ તરીકે ઉપયોગ કરો.',
    founderPromise:
      'અનિશ્ચિત ક્ષણોમાં પ્રેડિક્ટા ઉપયોગી, સુંદર અને સન્માનપૂર્ણ રહેવી જોઈએ. સુરક્ષામાં કોઈ સમજૂતી નથી.',
    hero: {
      body: 'શાંત માર્ગદર્શન, ચાર્ટ પુરાવો અને સ્પષ્ટ મર્યાદા સાથે ગંભીર જ્યોતિષ પ્રશ્નો પૂછો.',
      eyebrow: 'જાહેર સુરક્ષા વચન',
      title: 'પ્રેડિક્ટા guide કરવા માટે છે, ડરાવવા માટે નહીં.',
    },
    ...
    standard: {
      body: 'પ્રેડિક્ટા ડર, પક્કી ખાતરી અથવા સંકટમાં અતિ-દખલ વિના માર્ગદર્શન આપે છે. લક્ષ્ય કાળજી છે, અનાવશ્યક ઇનકાર નહીં.',
      eyebrow: 'અમારો ધોરણ',
