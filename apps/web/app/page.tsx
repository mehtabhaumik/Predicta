...
> = {
  ...
  hi: {
    capabilities: [
      {
        body: 'कुंडली बनाएं और पढ़ाई को असली चार्ट प्रमाण से जोड़े रखें.',
        title: 'कुंडली बनाना',
      },
      {
      ...
      {
        body: 'चार्ट, रिपोर्ट या सेव प्रोफाइल से सीधे पूछें.',
        title: 'प्रेडिक्टा चैट',
      },
      {
        body: 'सुंदर मुफ्त झलक और गहरी प्रीमियम रिपोर्ट बनाएं.',
        title: 'रिपोर्ट गहराई',
      },
    ],
    capabilityEyebrow: 'प्रेडिक्टा क्या करती है',
    ...
    intelligenceIntro: 'प्रेडिक्टा गहरी वैदिक जानकारी रखती है, पर सिर्फ काम की बात समझाती है.',
    intelligenceItems: [
      'होलिस्टिक ज्योतिष सार',
      'विभाजन चार्ट की समझ',
      'विंशोत्तरी दशा समय',
    ...
    intelligencePanelBody:
      'प्रेडिक्टा दशा, ग्रह स्थिति, चार्ट क्षेत्र, पंचांग, पुरुषार्थ और उपाय संदर्भ पढ़ती है, लेकिन पढ़ाई भारी नहीं बनाती.',
    intelligencePanelTitle: 'पेशेवर चार्ट समझ, साफ भाषा में.',
    intelligenceTitle: 'गहराई, शोर नहीं.',
    plansEyebrow: 'योजनाएं',
    plansIntro: 'मुफ्त शुरू करें, डे पास आजमाएं, या गहरी रिपोर्ट और अधिक मार्गदर्शन चाहिए तो प्रीमियम लें.',
    plansTitle: 'बिना दबाव प्रीमियम प्रवेश.',
    previewReport: 'रिपोर्ट झलक देखें',
    reportCopyBody:
      'सारांश, संकेत और मार्गदर्शन छोटी और गहरी दोनों रिपोर्ट में सुंदर रहते हैं.',
    reportCopyTitle: 'व्यक्तिगत और शांत अनुभव के लिए बनाया गया.',
    reportCoverBody:
      'मुफ्त और प्रीमियम रिपोर्ट की दृश्य गुणवत्ता समान रहती है. प्रीमियम गरिमा नहीं, गहराई जोड़ता है.',
    ...
    reportsTitle: 'मुफ्त रूप में भी साझा करने योग्य रिपोर्ट.',
  },
  gu: {
    capabilities: [
      {
        body: 'કુંડળી બનાવો અને વાંચનને સાચા ચાર્ટ પુરાવા સાથે જોડેલું રાખો.',
        title: 'કુંડળી બનાવવી',
      },
      {
      ...
      {
        body: 'ચાર્ટ, રિપોર્ટ અથવા સેવ પ્રોફાઇલ પરથી સીધું પૂછો.',
        title: 'પ્રેડિક્ટા ચેટ',
      },
      {
        body: 'સુંદર મફત ઝલક અને ઊંડા પ્રીમિયમ રિપોર્ટ્સ બનાવો.',
        title: 'રિપોર્ટ ઊંડાઈ',
      },
    ],
    capabilityEyebrow: 'પ્રેડિક્ટા શું કરે છે',
    ...
    intelligenceIntro: 'પ્રેડિક્ટા ઊંડી વૈદિક માહિતી રાખે છે, પણ કામની વાતો જ સમજાવે છે.',
    intelligenceItems: [
      'હોલિસ્ટિક જ્યોતિષ સાર',
      'વિભાગીય ચાર્ટની સમજ',
      'વિંશોત્તરી દશા સમય',
    ...
    intelligencePanelBody:
      'પ્રેડિક્ટા દશા, ગ્રહ સ્થિતિ, ચાર્ટ ક્ષેત્ર, પંચાંગ, પુરુષાર્થ અને ઉપાય સંદર્ભ વાંચે છે, પણ વાંચન ભારે નથી બનાવતી.',
    intelligencePanelTitle: 'પેશાદાર ચાર્ટ સમજ, સરળ ભાષામાં.',
    intelligenceTitle: 'ઊંડાઈ, અવાજ નહીં.',
    plansEyebrow: 'યોજનાઓ',
    plansIntro: 'મફત શરૂ કરો, ડે પાસ અજમાવો, અથવા ઊંડી રિપોર્ટ અને વધુ માર્ગદર્શન જોઈએ ત્યારે પ્રીમિયમ લો.',
    plansTitle: 'દબાણ વગર પ્રીમિયમ પ્રવેશ.',
    previewReport: 'રિપોર્ટ ઝલક જુઓ',
    reportCopyBody:
      'સારાંશ, સંકેત અને માર્ગદર્શન ટૂંકા અને ઊંડા બંને રિપોર્ટ્સમાં સુંદર રહે છે.',
    reportCopyTitle: 'વ્યક્તિગત અને શાંત અનુભવ માટે બનાવ્યું.',
    reportCoverBody:
      'મફત અને પ્રીમિયમ રિપોર્ટ્સની દેખાવ ગુણવત્તા સમાન રહે છે. પ્રીમિયમ ગૌરવ નહીં, ઊંડાઈ ઉમેરે છે.',
    ...
    reportsTitle: 'મફત રૂપમાં પણ શેર કરવા યોગ્ય રિપોર્ટ્સ.',
  },
};
