...
> = {
  ...
  hi: {
    ...
    plansEyebrow: 'प्लान',
    plansIntro: 'मुफ्त शुरू करें, Day Pass आजमाएं, या गहरी रिपोर्ट और अधिक मार्गदर्शन चाहिए तो प्रीमियम लें.',
  ...
  gu: {
    ...
    plansEyebrow: 'પ્લાન',
    plansIntro: 'મફત શરૂ કરો, Day Pass અજમાવો, અથવા ઊંડી રિપોર્ટ અને વધુ માર્ગદર્શન જોઈએ ત્યારે પ્રીમિયમ લો.',
