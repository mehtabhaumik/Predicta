...
function buildPostKundliCreatedSuggestions(
  ...
  return getPredictaWebChatCopy(language).postKundliSuggestions.map(
...
function buildSchoolContextIntro(
  ...
  return [
    `${school} is ready.`,
    fromSchool
      ? `Context was carried from ${fromSchool}. I will use this room's evidence for the answer and start with the prediction.`
      : undefined,
