  ...
  if (language === 'hi') {
    const map: Partial<Record<ReportMarketplaceProduct['id'], Partial<ReportMarketplaceProduct>>> = {
      ...
      KP: {
        ...
        freeDepth: 'कस्प और सब-लॉर्ड पर केंद्रित उपयोगी KP प्रमाण पथ.',
        freeIncludes: ['KP कस्प झलक', 'स्टार/सब-लॉर्ड प्रमाण', 'घटना भाव', 'पद्धति सीमा'],
        outcome: 'घटना प्रश्नों को KP प्रेडिक्टा से पढ़ें, पराशरी मिश्रण के बिना.',
        premiumDepth: 'कस्प chain, सिग्निफिकेटर, रूलिंग प्लैनेट और घटना समय वाली विस्तृत KP रिपोर्ट.',
      ...
      NUMEROLOGY: {
        ...
        premiumIncludes: ['नाम spelling तुलना', 'निजी timing map', 'Compatibility numbers', 'Numerology PDF section'],
  ...
  if (language === 'gu') {
    const map: Partial<Record<ReportMarketplaceProduct['id'], Partial<ReportMarketplaceProduct>>> = {
      ...
      KP: {
        ...
        freeDepth: 'cusp અને sub-lord પર કેન્દ્રિત ઉપયોગી KP પુરાવા માર્ગ.',
        freeIncludes: ['KP cusp ઝલક', 'star/sub-lord પુરાવો', 'ઘટના ભાવ', 'પદ્ધતિ મર્યાદા'],
        outcome: 'ઘટના પ્રશ્નો KP પ્રેડિક્ટાથી વાંચો, પરાશરી ભેળસેળ વગર.',
        premiumDepth: 'cusp chain, significators, ruling planets અને ઘટના સમય સાથે વિગતવાર KP રિપોર્ટ.',
