...
function getPredictaPageTitle(pathname: string | null): string {
  ...
  const titleMap: Record<string, string> = {
    ...
    '/dashboard/matchmaking': 'Matchmaking | Predicta',
    '/dashboard/jaimini': 'Jaimini Predicta | Predicta',
    '/dashboard/jaimini/chat': 'Chat with Jaimini Predicta | Predicta',
    '/dashboard/nadi': 'Jaimini Predicta | Predicta',
    '/dashboard/nadi/chat': 'Chat with Jaimini Predicta | Predicta',
    ...
    '/dashboard/relationship': 'Matchmaking | Predicta',
